...
(function(S, K) {
    ...
    (function(a) {
        ...
        a.Fx.prototype = {
            dSetter: function() {
                ...
                if (1 === t) l = this.toD;
                    ...
                    for (; n--;) v = parseFloat(a[n]), l[n] = isNaN(v) ? f[n] : t * parseFloat(f[n] - v) + v;
                else l = f;
                this.elem.attr("d",
                    l, null, !0)
            },
            ...
            step: function(q) {
                ...
                n.attr && !n.element ? q = !1 : q || f >= u + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), l = c[this.prop] = !0, a.objectEach(c, function(a) {
                    !0 !== a && (l = !1)
                }), l && v && v.call(n), q = !1) : (this.pos = t.easing((f - this.startTime) / u), this.now = this.start + (this.end - this.start) * this.pos, this.update(), q = !0);
                return q
            },
        ...
        a.numberFormat = function(q, f, l, t) {
            ...
            var n = a.defaultOptions.lang,
                ...
                u,
                c, b = q.toString().split("e"); - 1 === f ? f = Math.min(v, 20) : a.isNumber(f) ? f && b[1] && 0 > b[1] && (u = f + +b[1], 0 <= u ? (b[0] = (+b[0]).toExponential(u).split("e")[0], f = u) : (b[0] = b[0].split(".")[0] || 0, q = 20 > f ? (b[0] * Math.pow(10, b[1])).toFixed(f) : 0, b[1] = 0)) : f = 2;
        ...
        a.fireEvent = function(q, f, l, t) {
            ...
            H.createEvent && (q.dispatchEvent || q.fireEvent) ? (n = H.createEvent("Events"), n.initEvent(f, !0, !0),
                ...
                if (q[m])
                    for (v = q[m][f] || [], u = v.length, l.target || a.extend(l, {
    ...
    (function(a) {
        ...
        a.Color.prototype = {
            ...
            init: function(l) {
                ...
                else if (l && l.charAt && "#" === l.charAt() && (f = l.length, l = parseInt(l.substr(1), 16), 7 === f ? n = [(l & 16711680) >> 16, (l & 65280) >> 8, l & 255, 1] : 4 === f && (n = [(l & 3840) >> 4 | (l & 3840) >> 8, (l & 240) >> 4 | l & 240, (l & 15) << 4 | l & 15, 1])), !n)
                    for (v = this.parsers.length; v-- && !n;) u = this.parsers[v], (f = u.regex.exec(l)) && (n = u.parse(f));
                this.rgba = n || []
            },
            get: function(a) {
                var l = this.input,
        ...
        h(B.prototype, {
            ...
            colorGradient: function(y, g, c) {
                ...
                b && (e = y[b], p = w.gradients, x = y.stops, A = c.radialReference, I(e) && (y[b] = e = {
                    ...
                    b && A && !u(e.gradientUnits) && (k = e, e = F(e, w.getRadialAttr(A, k), {
                        gradientUnits: "userSpaceOnUse"
                    })), J(e, function(a, y) {
                        "id" !== y && r.push(y, a)
                    }), J(x, function(a) {
            ...
            applyTextOutline: function(y) {
                var g = this.element,
                    c, w, h, e, b; - 1 !== y.indexOf("contrast") && (y = y.replace(/contrast/g, this.renderer.getContrast(g.style.fill)));
                y = y.split(" ");
                w = y[y.length - 1];
            ...
            addClass: function(a, g) {
                var y = this.attr("class") || ""; - 1 === y.indexOf(a) && (g || (a = (y + (y ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
                return this
            },
            hasClass: function(a) {
            ...
            zIndexSetter: function(a, c) {
                ...
                if (e) {
                    ...
                    for (p = c.length - 1; 0 <= p && !d; p--)
                        if (y = c[p],
                            e = y.zIndex, k = !u(e), y !== b)
                            if (0 > a && k && !w && !p) h.insertBefore(b, c[p]), d = !0;
                            else if (g(e) <= a || k && (!u(a) || 0 <= a)) h.insertBefore(b, c[p + 1] || null), d = !0;
        ...
        h(H.prototype, {
                        ...
                        d(e, function(g) {
                            if ("" !== g || 1 === e.length) {
                                ...
                                A.test(g) && !h && (f(k, "onclick", 'location.href\x3d"' + g.match(A)[1] +
                                    '"'), f(k, "class", "highcharts-anchor"), n(k, {
                                    cursor: "pointer"
                                }));
            ...
            symbol: function(a, g, c, w, b, e) {
                ...
                A ? (p = this.path(F), p.attr("fill", "none"), h(p, {
                    ...
                    x: g,
                    y: c
                }), p.isImg = !0, u(p.imgwidth) && u(p.imgheight) ? L() : (p.attr({
                    width: 0,
                    height: 0
                }), v("img", {
                    onload: function() {
        ...
        a.Time.prototype = {
            ...
            update: function(n) {
                ...
                (this.variableTimezone = !(l && !n.getTimezoneOffset && !n.timezone)) || this.timezoneOffset ? (this.get = function(a, b) {
                    ...
                    else d = u.getTimezoneOffset(b), d = b.getTime() - d, b.setTime(d), b["setUTC" + c](m), c = u.getTimezoneOffset(b), d = b.getTime() + c, b.setTime(d)
    ...
    (function(a) {
        ...
        a.defaultOptions = {
            ...
            credits: {
                ...
                text: "Istar Skill Development Pvt Ltd"
            }
        };
        ...
        a.Tick.prototype = {
            ...
            handleOverflow: function(a) {
                var f = this.axis,
                    ...
                    z = 1,
                    M, D = {};
                if (k || !1 === n.overflow) 0 > k && c - e * p < d ? M = Math.round(c / Math.cos(k * t) - d) : 0 < k && c + e * p > m && (M = Math.round((b - c) / Math.cos(k * t)));
                else if (b = c + (1 -
            ...
            getLabelPosition: function(a, l, f, c, b, m, d, h) {
                var k = this.axis,
                    ...
                    z = b.y,
                    u = c || k.reserveSpaceDefault ? 0 : -k.labelOffset * ("center" === k.labelAlign ? .5 : 1);
    ...
    var V = function(a) {
        ...
        a.extend(G.prototype, {
            ...
            init: function(a, c) {
                ...
                c = b.options.events; - 1 === e(b, a.axes) && (g ? a.axes.splice(a.xAxis.length, 0, b) : a.axes.push(b), a[b.coll].push(b));
                b.series = b.series || [];
            ...
            defaultLabelFormatter: function() {
                var g = this.axis,
                    ...
                    x = p && p.length,
                    r, m = g.options.labels.format,
                    g = g.isLog ? Math.abs(c) : g.tickInterval;
                if (m) r = d(m, this, b);
                else if (e) r = c;
                else if (h) r = b.dateFormat(h, c);
                else if (x && 1E3 <= g)
                    for (; x-- && void 0 === r;) b = Math.pow(k, x + 1), g >= b && 0 === 10 * c % b && null !== p[x] && 0 !== c && (r = a.numberFormat(c / b, -1) + p[x]);
                ...
                c(a.series,
                    function(g) {
                        if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                            ...
                            if (a.isXAxis) c = g.xData, c.length && (g = q(c), d = E(c), r(g) || g instanceof Date || (c = k(c, r), g = q(c), d = E(c)), c.length && (a.dataMin = Math.min(C(a.dataMin, c[0], g), g), a.dataMax = Math.max(C(a.dataMax, c[0], d), d)));
                            else if (g.getExtremes(), d = g.dataMax, g = g.dataMin, n(g) && n(d) && (a.dataMin = Math.min(C(a.dataMin, g), g), a.dataMax = Math.max(C(a.dataMax, d), d)), n(w) && (a.threshold =
            ...
            getPlotLinePath: function(a, c, b, d, e) {
                var g = this.chart,
                    w = this.left,
                    h = this.top,
                    k, p, x = b && g.oldChartHeight || g.chartHeight,
            ...
            getMinorTickPositions: function() {
                var a = this,
                    ...
                    x = k - p;
                if (x && x / e < a.len / 3)
                    if (a.isLog) c(this.paddedTicks, function(g, c, b) {
                        c && h.push.apply(h, a.getLogTickPositions(e, b[c - 1], b[c], !0))
                    });
                    else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) h = h.concat(a.getTimeTicks(a.normalizeTimeTickInterval(e), p, k, b.startOfWeek));
                else
                    for (b = p + (d[0] - p) % e; b <= k && b !== h[0]; b += e) h.push(b);
            ...
            nameToX: function(a) {
                ...
                n(b) || (b = !1 === this.options.uniqueNames ? a.series.autoIncrement() : g ? e(a.name, c) : C(c.keys[a.name], -1)); - 1 === b ? g || (d = c.length) : d = b;
            ...
            zoom: function(a, b) {
                ...
                if (a !== this.min || b !== this.max) this.allowZoomOutside ||
                    (n(g) && (a < e && (a = e), a > d && (a = d)), n(c) && (b < e && (b = e), b > d && (b = d))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {
                        trigger: "zoom"
                    });
                return !0
            },
            ...
            renderUnsquish: function() {
                ...
                if (this.autoRotation) f > x && f > m.h ? r.rotation = this.labelRotation : this.labelRotation = 0;
                else if (p && (F = x, !A))
                    for (l = "clip", x = d.length; !k && x--;)
                        if (z = d[x], z = e[z].label) z.styles && "ellipsis" === z.styles.textOverflow ? z.css({
                                textOverflow: "clip"
                            }) :
                            z.textPxLength > p && z.css({
                                width: p + "px"
                            }), z.getBBox().height > this.len / d.length - (m.h - m.f) && (z.specificTextOverflow = "ellipsis");
            ...
            getOffset: function() {
                ...
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (v || "")).add(M), a.axisGroup = d.g("axis").attr({
                    zIndex: e.zIndex || 2
                }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (v || "")).add(M), a.labelGroup = d.g("axis-labels").attr({
                    zIndex: J.zIndex ||
                        7
            ...
            drawCrosshair: function(a, b) {
                ...
                this.crosshair && !1 !== (n(b) || !e) ? (e ? n(b) && (g = this.isXAxis ? b.plotX : this.len - b.plotY) : g = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), n(g) && (c = this.getPlotLinePath(b && (this.isXAxis ? b.x : C(b.stackY, b.y)), null, null, null, g) || null), n(c) ? (b = this.categories && !this.isRadial, h || (this.cross = h = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" +
                    (b ? "category " : "thin ") + d.className).attr({
                    zIndex: C(d.zIndex, 2)
                }).add(), h.attr({
    ...
    (function(a) {
        ...
        B.prototype.getLogTickPositions = function(a, t, n, v) {
            ...
            if (.5 <= a) a = Math.round(a), d = this.getLinearTickPositions(a, t, n);
            else if (.08 <= a)
                for (var c = Math.floor(t), h, k,
                        e, p, r, l = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; c < n + 1 && !r; c++)
                    for (k = l.length, h = 0; h < k && !r; h++) e = m(b(c) * l[h]), e > t && (!v || p <= n) && void 0 !== p && d.push(p), p > n && (r = !0), p = e;
            else t = b(t), n = b(n), a = v ? this.getMinorTickInterval() : l.tickInterval, a = f("auto" === a ? null : a, this._minorAutoInterval, l.tickPixelInterval / (v ? 5 : 1) * (n - t) / ((v ? c / this.tickPositions.length : c) || 1)), a = q(a, null, H(a)), d = E(this.getLinearTickPositions(a, t, n), m), v || (this._minorAutoInterval = a / 5);
    ...
    (function(a, B) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                if (l) D =
                    c.getPlotLinePath(p, z.strokeWidth());
                else if (r) D = c.getPlotBandPath(e, k, m);
                else return;
                t && D && D.length ? (z.attr({
                    d: D
                }), F && a.objectEach(F, function(a, b) {
                    z.on(b, function(a) {
                        F[b].apply(f, [a])
                    })
                })) : z && (D ? (z.show(), z.animate({
                    d: D
        ...
        a.extend(B.prototype, {
            getPlotBandPath: function(a, c) {
                ...
                if (m && b)
                    for (a && (e = m.toString() === b.toString(), k = 0), a = 0; a < m.length; a += 6) h && b[a + 1] === m[a + 1] ? (b[a + 1] += k, b[a + 4] += k) : h || b[a + 2] !== m[a + 2] || (b[a + 2] += k, b[a + 5] += k), d.push("M", m[a + 1], m[a + 2], "L", m[a + 4], m[a + 5], b[a + 4], b[a + 5], b[a + 1], b[a + 2], "z"), d.flat = e;
                return d
            },
        ...
        a.Tooltip.prototype = {
            ...
            getPosition: function(a, b, m) {
                var c = this.chart,
                    ...
                    e = c.inverted &&
                    m.h || 0,
                    p, r = ["y", c.chartHeight, b, m.plotY + c.plotTop, c.plotTop, c.plotTop + c.plotHeight],
            ...
            refresh: function(a, b) {
                ...
                d.enabled && (clearTimeout(this.hideTimer),
                    this.followPointer = n(k)[0].series.tooltipOptions.followPointer, e = this.getAnchor(k, b), b = e[0], h = e[1], !p || k.series && k.series.noSharedTooltip ? p = k.getLabelConfig() : (B(k, function(a) {
                        ...
                        x: k[0].category,
                        y: k[0].y
                    }, p.points = r, k = k[0]), this.len = r.length, p = c.call(p, this), f = k.series, this.distance = t(f.tooltipOptions.distance, 16), !1 === p ? this.hide() : (c = this.getLabel(), this.isHidden && c.attr({
                        opacity: 1
                    }).show(), this.split ? this.renderSplit(p, n(a)) : (d.style.width || c.css({
                            width: this.chart.spacingBox.width
                        }),
                        c.attr({
                            text: p && p.join ? p.join("") : p
                        }), c.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + t(k.colorIndex, f.colorIndex)), c.attr({
        ...
        a.Pointer.prototype = {
            ...
            findNearestKDPoint: function(a, c, d) {
                ...
                t(a, function(a) {
                    ...
                    a = a.searchPoint(d, h);
                    if ((h = b(a, !0)) && !(h = !b(e, !0))) var h = e.distX - a.distX,
                        k = e.dist - a.dist,
            ...
            runPointActions: function(b, c) {
                var e = this.chart,
                    h = e.tooltip && e.tooltip.options.enabled ?
                    e.tooltip : void 0,
                    k = h ? h.shared : !1,
                    p = c || e.hoverPoint,
                    f = p && p.series || e.hoverSeries,
                    f = this.getHoverData(p, f, e.series, !!c || f && f.directTouch && this.isDirectTouch, k, b, {
    ...
    (function(a) {
        ...
        E(a.Pointer.prototype, {
            ...
            pinchTranslateDirection: function(a, f, l, q, c, b, m, d) {
                ...
                w ? (J -= .8 * (J - m[k][0]), F || (g -= .8 * (g - m[k][1])), l()) : m[k] = [J, g];
                C || (b[k] = t - n, b[r] = z);
                b = C ? 1 / D : D;
                c[r] = z;
                c[k] = f;
            ...
            touch: function(f, n) {
                ...
                1 === f.touches.length ? (f = this.normalize(f), (c = t.isInsidePlot(f.chartX - t.plotLeft, f.chartY - t.plotTop)) && !t.openMenu ? (n && this.runPointActions(f), "touchmove" === f.type && (n = this.pinchDown, q = n[0] ? 4 <= Math.sqrt(Math.pow(n[0].chartX - f.chartX, 2) + Math.pow(n[0].chartY - f.chartY, 2)) : !1), l(q, !0) && this.pinch(f)) : n && this.reset()) : 2 === f.touches.length && this.pinch(f)
            },
        ...
        a.Legend.prototype = {
            ...
            renderItem: function(a) {
                ...
                G || (a.legendGroup = c.g("legend-item").addClass("highcharts-" +
                        w.type + "-series highcharts-color-" + a.colorIndex + (O ? " " + O : "") + (g ? " highcharts-series-" + a.index : "")).attr({
                        zIndex: 1
                    }).add(this.scrollGroup), a.legendItem = G = c.text("", x ? m + l : -l, this.baseline || 0, N).css(n(a.visible ? z : q)).attr({
                        align: x ? "left" : "right",
                        zIndex: 2
            ...
            render: function() {
                ...
                a.offsetWidth = 0;
                a.lastItemY = 0;
                e || (a.group = e = k.g("legend").attr({
                    zIndex: 7
                }).add(), a.contentGroup = k.g().attr({
                    zIndex: 1
                }).add(e), a.scrollGroup = k.g().add(a.contentGroup));
                a.renderTitle();
                m = a.getAllItems();
                c(m, function(a, b) {
                ...
                z += C;
                q || (a.box = q = k.rect().addClass("highcharts-legend-box").attr({
                    r: D.borderRadius
                }).add(e), q.isNew = !0);
                q.attr({
                ...
                l && (k = b.spacingBox, /(lth|ct|rth)/.test(a.getAlignment()) && (k = n(k, {
            ...
            handleOverflow: function(a) {
                ...
                a > c && !1 !== D.enabled ? (this.clipHeight = z = Math.max(c - 20 - this.titleHeight - n, 0), this.currentPage = v(this.currentPage, 1), this.fullHeight = a, f(G, function(a, b) {
                    ...
                    c !== J && (J = c)
                }), q || (q = b.clipRect = d.clipRect(0, n, 9999, 0), b.contentGroup.clip(q)), g(z), F || (this.nav = F = d.g().attr({
                    zIndex: 1
                    ...
                    function() {
                        b.scroll(1, t)
                    }).add(F)), b.scroll(0), a = c) : F && (g(), this.nav = F.destroy(), this.scrollGroup.attr({
                    translateY: 1
                }), this.clipHeight = 0);
                return a
            },
    ...
    (function(a) {
        ...
        d(P.prototype, {
            ...
            redraw: function(b) {
                ...
                if (l)
                    for (b = g.length; b--;) F = g[b], F.options.stacking && (F.isDirty = !0);
                m(g, function(a) {
            ...
            layOutTitles: function(a) {
                ...
                m(["title", "subtitle"], function(a) {
                    ...
                    var k;
                    c && (k = h.style.fontSize, k = g.fontMetrics(k, c).b, c.css({
                        width: (h.width || e.width + h.widthAdjust) + "px"
                    }).align(d({
                        y: a + k
                ...
                this.titleOffset = b;
                !this.isDirtyBox && c && (this.isDirtyBox = c, this.hasRendered && F(a, !0) && this.isDirtyBox && this.redraw())
            },
        ...
        a.Point.prototype = {
            ...
            optionsToObject: function(a) {
                ...
                if (n(a) || null === a) b[h[0]] = a;
                    ...
                    for (!d && a.length > k && (c = typeof a[0], "string" === c ? b.name = a[0] : "number" === c && (b.x = a[0]), e++); f < k;) d && void 0 === a[e] || (b[h[f]] = a[e]),
                        e++, f++;
        ...
        a.Series = a.seriesType("line", null, {
            ...
            setData: function(b, c, e, f) {
                ...
                if (!1 !== f && x && l === x && !m.cropped && !m.hasGroupedData && m.visible) v(b, function(a, b) {
                    ...
                    if (z && x > z) {
                        ...
                        if (h(n))
                            for (e = 0; e < x; e++) q[e] = this.autoIncrement(), D[e] = b[e];
                        else if (d(n))
                            if (t)
                                for (e = 0; e < x; e++) n =
                                    b[e], q[e] = n[0], D[e] = n.slice(1, t + 1);
                            else
                                for (e = 0; e < x; e++) n = b[e], q[e] = n[0], D[e] = n[1];
                        else a.error(12)
                    } else
                        for (e = 0; e < x; e++) void 0 !== b[e] && (n = {
                            series: m
                        }, m.pointClass.prototype.applyOptions.apply(n, [b[e]]), m.updateParallelArrays(n, e));
            ...
            processData: function(b) {
                ...
                if (p && this.sorted && !x && (!m || e > m || this.forceCrop))
                    ...
                    else if (c[0] < z || c[e - 1] > q) h = this.cropData(this.xData,
            ...
            getExtremes: function(a) {
                ...
                e = a.length;
                for (n = 0; n < e; n++)
                    if (p = c[n], x = a[n], l = (h(x, !0) || d(x)) && (!b.positiveValuesOnly || x.length || 0 < x), p = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[n + 1] || p) >= f && (c[n - 1] || p) <= m, l && p)
                        if (l = x.length)
                            for (; l--;) "number" ===
                                typeof x[l] && (k[g++] = x[l]);
                        else k[g++] = x;
            ...
            translate: function() {
                ...
                for (a = 0; a < m; a++) {
                    ...
                    C = I.low;
                    var H =
                        c && k.stacks[(this.negStacks && E < (D ? 0 : q) ? "-" : "") + this.stackKey],
                        K;
            ...
            setClip: function(a) {
                ...
                f || (a && (h.width = 0, d && (h.x = b.plotSizeX), b[k + "m"] = m = e.clipRect(d ? b.plotSizeX + 99 : -99, d ? -b.plotLeft :
                    -b.plotTop, 99, d ? b.chartWidth : b.chartHeight)), b[k] = f = e.clipRect(h), f.count = {
                    length: 0
                });
            ...
            drawPoints: function() {
                var a = this.points,
                    ...
                    k, f, m, l = this[this.specialGroup] || this.markerGroup,
                    p, n = r(h.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx >= h.enabledThreshold * h.radius);
        ...
        u.prototype.modifyStacks = function() {
            ...
            a[k + "Stacker"] && l([b, "-" + b], function(b) {
                for (var c = d.length, e, l; c--;)
                    if (e = d[c], h = a.getStackIndicator(h, e, a.index, b), l = (e = f[b] && f[b][e]) && e.points[h.key]) a[k + "Stacker"](l, e, c)
            })
        };
            ...
            update: function(a, d, f) {
                ...
                t("xAxis yAxis zAxis series colorAxis pane".split(" "), function(b) {
                    a[b] && (t(M(a[b]), function(a, c) {
                        (c = l(a.id) && p.get(a.id) || p[b][c]) && c.coll === b && (c.update(a, !1), f && (c.touched = !0));
                        if (!c && f)
        ...
        v(r.prototype, {
            ...
            update: function(a, b) {
                var c = this,
                    ...
                    g = I[f].prototype,
                    l, m = ["group", "markerGroup", "dataLabelsGroup"],
        ...
        l("area", "line", {
            ...
            getStackPoints: function(f) {
                var l = [],
                    ...
                    h = c.series,
                    k = h.length,
                    e, p = q(c.options.reversedStacks, !0) ? 1 : -1,
                    r;
                f = f || this.points;
                if (this.options.stacking) {
                    ...
                    H(t, function(a, h) {
                        ...
                        if (m[a] && !m[a].isNull) l.push(m[a]), H([-1, 1], function(c) {
                            var f = 1 === c ? "rightNull" : "leftNull",
                                ...
                                q = b[t[h + c]];
                            if (q)
                                for (r = d; 0 <= r && r < k;) n = q.points[r], n || (r === d ? m[a][f] = !0 : e[r] && (z = b[a].points[r]) && (l -= z[1] - z[0])), r += p;
            ...
            getGraphPath: function(a) {
                var l = f.prototype.getGraphPath,
                    ...
                    h = [],
                    k = this.index,
                    e, p = c.stacks[this.stackKey],
                    r = t.threshold,
                    I = c.getThreshold(t.threshold),
                    z, t = t.connectNulls || "percent" === u,
                    M = function(b, f, l) {
                        var m = a[b];
                        b = u && p[m.x].points[k];
                        var n = m[l + "Null"] || 0;
                ...
                for (b = 0; b < a.length; b++)
                    if (m = a[b].isNull, e = q(a[b].rectPlotX, a[b].plotX), z = q(a[b].yBottom, I), !m || t) t || M(b, b - 1, "left"), m && !u && t || (h.push(a[b]), d.push({
                        x: b,
                        plotX: e,
                        plotY: z
                    })), t || M(b, b + 1, "right");
                ...
                H(u, function(c) {
                    ...
                    f ? (f.endX = a.preventGraphAnimation ?
                        null : l.xMap, f.animate({
                            d: l
                        })) : (f = a[b] = a.chart.renderer.path(l).addClass(c[1]).attr({
        ...
        v("column", "line", {
            ...
            animate: function(a) {
                var b = this,
                    ...
                    l;
                u && (a ? (f.scaleY = .001, a = Math.min(c.pos + c.len, Math.max(c.pos, c.toPixels(d.threshold))), h ? f.translateX = a - c.len : f.translateY = a, b.group.attr(f)) : (l = b.group.attr(e), b.group.animate({
                    scaleY: 1
        ...
        b("pie", "line", {
            ...
            updateTotals: function() {
                var a, b = 0,
                    c = this.points,
                    e = c.length,
                    f, l = this.options.ignoreHiddenPoint;
            ...
            translate: function(a) {
                ...
                var b = 0,
                    ...
                    e = c.slicedOffset,
                    d = e + (c.borderWidth || 0),
                    f, m, n, q = l(c.startAngle, c.endAngle),
                    t = this.startAngleRad = q.start,
                    q = (this.endAngleRad = q.end) - t,
                    u = this.points,
                    x, F = c.dataLabels.distance,
            ...
            drawPoints: function() {
                ...
                q(a.points, function(d) {
                    ...
                    if (d.isNull) e && (d.graphic = e.destroy());
                        ...
                        e ? e.setRadialReference(a.center).attr(l).animate(f(m, c)) : (d.graphic = e = b[d.shapeType](m).setRadialReference(a.center).attr(c).add(a.group), d.visible || e.attr({
                            visibility: "hidden"
                        }), e.attr(l).attr({
                            "stroke-linejoin": "round"
                        }).shadow(n, h));
    ...
    (function(a) {
        ...
        b.prototype.drawDataLabels = function() {
            ...
            var c = this,
                ...
                f = d.dataLabels,
                m = c.points,
                z, t, v = c.hasRendered || 0,
                C, x, F = u(f.defer, !!d.animation),
                A = e.renderer;
            if (f.enabled || c._hasPointLabels) c.dlProcessOptions && c.dlProcessOptions(f), x = c.plotGroup("dataLabelsGroup", "data-labels", F && !v ? "hidden" : "visible", f.zIndex || 6), F && (x.attr({
                opacity: +v
            }), v || B(c, "afterAnimate", function() {
                c.visible && x.show(!0);
        ...
        b.prototype.alignDataLabel = function(a, b, c, d, l) {
            ...
            if (t && (p = c.style.fontSize, p = e.renderer.fontMetrics(p, b).b, d = f({
                ...
                }, b[l ? "attr" : "animate"](k).attr({
                    align: r
                }), m = (q + 720) % 360, m = 180 < m && 360 > m, "left" === r ? k.y -= m ? n.height : 0 : "center" === r ? (k.x -= n.width / 2, k.y -= n.height /
        ...
        m.pie && (m.pie.prototype.drawDataLabels = function() {
            ...
            c.visible && (l.enabled || c._hasPointLabels) && (q(d, function(a) {
                ...
                var h, k, n = b.length,
                    ...
                    r;
                if (n)
                    for (c.sortByAngle(b, d - .5), 0 < c.maxLabelDistance &&
    ...
    (function(a) {
        ...
        B.prototype.hideOverlappingLabels =
            function(a) {
                var f = a.length,
                    q, n, v, u, c, b, m, d, h, k = function(a, b, c, d, f, h, k, l) {
                        return !(f > a + c || f + k < a || h > b + d || h + l < b)
                    };
                for (n = 0; n < f; n++)
                    if (q = a[n]) q.oldOpacity = q.opacity, q.newOpacity = 1, q.width || (v = q.getBBox(), q.width = v.width, q.height = v.height);
                a.sort(function(a, b) {
                    return (b.labelrank || 0) - (a.labelrank || 0)
                });
                for (n = 0; n < f; n++)
                    for (v = a[n], q = n + 1; q < f; ++q)
                        if (u = a[q], v && u && v !== u && v.placed && u.placed && 0 !== v.newOpacity && 0 !== u.newOpacity && (c = v.alignAttr, b = u.alignAttr, m = v.parentGroup, d = u.parentGroup, h = 2 * (v.box ? 0 : v.padding ||
        ...
        n(k.prototype, {
            ...
            setState: function(a, b) {
                var c = Math.floor(this.plotX),
                    ...
                    t = e.chart,
                    u = e.halo,
                    z, B = k && e.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === f.enabled || a && (g || m && !1 === p.enabled) || a && r.states && r.states[a] && !1 ===
                        r.states[a].enabled)) {
                    B && (z = e.markerAttribs(this, a));
                    if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(e.pointAttribs(this, a), h(t.options.chart.animation, f.animation)), z && this.graphic.animate(z, h(t.options.chart.animation, p.animation, k.animation)), q && q.hide();
                    else {
                        if (a && p) {
                            k = r.symbol || e.symbol;
                    ...
                    }(c = f.halo) && c.size ? (u || (e.halo = u = t.renderer.path().add((this.graphic || q).parentGroup)), u.show()[b ? "animate" : "attr"]({
                        d: this.haloPath(c.size)
                    }), u.attr({
                        "class": "highcharts-halo highcharts-color-" + h(this.colorIndex, e.colorIndex)
                    }), u.point = this, u.attr(n({
        ...
        n(e.prototype, {
            ...
            setState: function(a) {
                ...
                if (b.state !== a && (t([b.group, b.markerGroup, b.dataLabelsGroup], function(c) {
                    ...
                    for (f = {
                            "stroke-width": f
                        }, d.animate(f, h(e[a || "normal"] && e[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c];) b["zone-graph-" + c].attr(f), c += 1
            },
            setVisible: function(a, b) {
                var c = this,
                    d = c.chart,
            ...
            function n(c,
                ...
                a.objectEach(c, function(a, c) {
                    if (!d && -1 < E(c, ["series", "xAxis", "yAxis"]))
                        for (a = t(a), l[c] = [], h = 0; h < a.length; h++) b[c][h] && (l[c][h] = {}, n(a[h], b[c][h], l[c][h], d + 1));
                    else f(a) ? (l[c] = q(a) ? [] : {}, n(a, b[c] || {}, l[c], d + 1)) : l[c] = b[c] || null
                })
            }
            var u = {};
